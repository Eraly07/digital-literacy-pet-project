...
function saveName(){
  ...
  if(pendingScore){
    addBoard(pName,pendingScore.score,pendingScore.courseId,pendingScore.courseTitle);
    pendingScore=null;
    if(currentCourseId) renderFinalQuestion(currentCourseId);
  }
}
...
function submitFinalScore(course,pct){
  if(!pName){
    pendingScore={score:pct,courseId:course.id,courseTitle:course.title};
