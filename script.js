...
const COURSES=[
  {
    ...
    modules:[
      {title:'Фишинг түрлері мен белгілері',text:'Фишинг — сенімді ұйым болып көрініп, жеке дерек немесе ақша сұрайтын алаяқтық. Белгілері: асықтыру, қорқыту, қате домен, күдікті сілтеме.',qIdx:[0,1,2,3]},
      {title:'Тексеру әдістері',text:'Кез келген сұранысты ресми арнадан тексер. URL-дегі доменді, хат жіберушіні және ресми сайттағы байланыс нөмірін салыстыр.',qIdx:[4,5,6,7]},
      {title:'Қорғаныс және әрекет',text:'2FA қос, күдікті файл ашпа, жеке деректерді берме. Қауіп болса — құпиясөзді ауыстырып, банкке хабарлас.',qIdx:[8,9,10,11]},
    ],
    questions:[
      {q:'Фишинг деген не?',o:['Интернеттегі ойын','Сенімді ұйым болып көрініп деректерді ұрлау','Вирусты жою әдісі','Желіні жылдамдату'],a:1,e:'Фишинг — ұйымды немесе адамды бейнелеп, дерек ұрлау.'},
      {q:'Хаттағы ең күдікті белгі қандай?',o:['Ресми домен','Жедел әрекет етуге қысым','Дұрыс грамматика','Жеке атымен танысу'],a:1,e:'Асықтыру мен қысым — фишингтің жиі белгісі.'},
      {q:'Банк SMS‑кодты сұрай ма?',o:['Иә, әрқашан','Жоқ, банк код сұрамайды','Тек түнде','Тек мессенджерде'],a:1,e:'Банк ешқашан SMS кодты сұрамайды.'},
      {q:'Сілтемені тексерудің дұрыс тәсілі',o:['Бірден басу','Тінтуірмен апарып, нақты доменді көру','Қысқартылған URL-ды ғана көру','Достарға жіберу'],a:1,e:'Алдымен нақты доменді көріп тексер.'},
      {q:'Қауіпсіздік қызметі қысым жасаса не істеу керек?',o:['Барлығын айтып беру','Қоңырауды тоқтатып, ресми нөмірге өзің хабарласу','SMS код жіберу','Аударым жасау'],a:1,e:'Ресми арнамен өзің қайта хабарлас.'},
      {q:'Фишингтің басты мақсаты',o:['Көңіл көтеру','Жеке деректер немесе ақша','Жарнама көру','Сайт безендіру'],a:1,e:'Мақсат — дерек немесе ақша алу.'},
      {q:'Күдікті файл келсе дұрыс әрекет',o:['Тексерусіз ашу','Антивирусты өшіру','Ашпай, жою және жіберушіні тексеру','Достарға тарату'],a:2,e:'Күдікті файлды ашпа, тексер.'},
      {q:'HTTPS бар сайт толық қауіпсіз бе?',o:['Иә, 100%','Жоқ, жалған домен болуы мүмкін','Тек банктерге','Тек әлеуметтік желілерге'],a:1,e:'HTTPS шифрлайды, бірақ фишингтен қорғамайды.'},
      {q:'Фишингтен қорғанудың бір тәсілі',o:['Бір пароль қолдану','2FA қосу','Барлығын жариялау','Құрылғыны root ету'],a:1,e:'2FA аккаунтты күшейтеді.'},
      {q:'Алаяқтар жиі қолданатын тәсіл',o:['Асықтыру','Ұзақ күту','Ресми келісімшарт','Құжаттарды жіберу'],a:0,e:'Асықтыру — шешім қабылдатудың тәсілі.'},
      {q:'Қауіпті сілтемені ашып қойсаң',o:['Ештеңе істемеу','Құпиясөзді ауыстыру және аккаунтты тексеру','Барлығына жіберу','Карта деректерін енгізу'],a:1,e:'Құпиясөзді ауыстырып, қауіпсіздікті тексер.'},
      {q:'Растау қай жерден жасалады?',o:['Мессенджердегі номерден','Сайттың ресми контактынан','Кездейсоқ чаттан','Таныс емес аккаунттан'],a:1,e:'Әрқашан ресми арнаны пайдалан.'},
    ]
  },
  {
    id:'passwords',
    ...
    modules:[
      {title:'Күшті пароль жасау',text:'Қауіпсіз пароль ұзын, бірегей және күрделі болуы керек. Қарапайым сөздер мен туған күн қауіпті.',qIdx:[0,1,2,3]},
      {title:'Сақтау және менеджер',text:'Пароль менеджерлері деректі шифрлап сақтайды. Деректердің бұзылғанын арнайы сервистер арқылы тексеруге болады.',qIdx:[4,5,6,7]},
      {title:'Қорғау әдеттері',text:'2FA қолданыңыз, құрылғыны құлыптаңыз және күмән туғанда парольді ауыстырыңыз.',qIdx:[8,9,10,11]},
    ],
    questions:[
      {q:'Күшті пароль қандай?',o:['Қысқа сөз','12+ символ, әріп/сан/белгі','Туған күн','Атыңыз'],a:1,e:'Ұзын әрі күрделі пароль қауіпсіз.'},
      {q:'Парольді қайталау несімен қауіпті?',o:['Қауіпсіз','Біреуін бұзса бәрі бұзылады','Ұсынылады','Тек банкте'],a:1,e:'Бір пароль бұзылса, барлық аккаунт ашылады.'},
      ...
      {q:'Парольді қашан ауыстыру керек?',o:['Күнде','Дерек ағып кетсе немесе күмән болса','Ешқашан','Апта сайын'],a:1,e:'Негізгі себеп — қауіп немесе күдік.'},
      ...
      {q:'Бұзылған парольді тексеру қайда?',o:['Достардан','Провайдерден','Breach тексеру сервистерінен','VPN-нан'],a:2,e:'Breach сервистері паролі ағып кеткенін көрсетеді.'},
      {q:'SMS коды мен authenticator салыстырмасында',o:['SMS қауіпсіз','Authenticator қауіпсіз','Екеуі бірдей','Екеуі қауіпті'],a:1,e:'Authenticator әдетте қауіпсізірек.'},
      ...
      {q:'Парольді біреуге беру',o:['Қауіпсіз','Тек жақындарға','Беруге болмайды','Чатта жіберуге болады'],a:2,e:'Құпиясөзді ешкімге берме.'},
      {q:'Brute‑force қорғау',o:['Қысқа пароль','Қате көп болса блоктау','Бірдей PIN','Құпиясөзді ашық жазу'],a:1,e:'Көп қате болса бұғаттау қорғайды.'},
    ]
  },
  {
    id:'social',
    ...
    modules:[
      {title:'Құпиялық пен бөлісу',text:'Профильді баршаға ашық етпе. Геолокация мен жеке деректерді шектеңіз.',qIdx:[0,1,2,3]},
      {title:'Қауіптер мен алаяқтар',text:'DM‑дегі сілтемелерге сақ бол. Giveaway және жалған аккаунттарды тексер.',qIdx:[4,5,6,7]},
      {title:'Қорғау және қалпына келтіру',text:'2FA қосыңыз, құрылғы сессияларын тексеріңіз және қалпына келтіру контактілерін жаңартыңыз.',qIdx:[8,9,10,11]},
    ],
    questions:[
      ...
      {q:'DM‑дегі сілтеме',o:['Бірден ашу','Жіберушіні тексеру','Барлығына тарату','Пароль енгізу'],a:1,e:'Алдымен кім жібергенін тексер.'},
      {q:'2FA қосу не үшін?',o:['Қажет емес','Аккаунтты қорғайды','Фотоларды әдемілейді','Контентті жояды'],a:1,e:'2FA аккаунт қауіпсіздігін күшейтеді.'},
      ...
      {q:'Қорлау/қысым болса',o:['Жауап беру','Блоктау және шағымдану','Елемеу','Өзің де қорлау'],a:1,e:'Блоктап, шағымдану дұрыс.'},
      {q:'Ескі посттар',o:['Қараудың қажеті жоқ','Уақыт өте қарап, қажетсізін өшіру','Барлығын ашық қалдыру','Тек скриншоттау'],a:1,e:'Ескі контентті бақылап отыр.'},
    ]
  },
  {
    id:'fake',
    title:'Жалған ақпарат (Фейк)',
    desc:'Фейкті тану, дереккөзді тексеру және фактілерді растау.',
    modules:[
      {title:'Фейк белгілері',text:'Айқайлы тақырып, эмоцияға қысым және дәлелдің жоқтығы — фейктің белгісі.',qIdx:[0,1,2,3]},
      {title:'Фактчек тәсілдері',text:'Дереккөз, дата, сурет және контекстті тексер. Бірнеше дереккөзді салыстыр.',qIdx:[4,5,6,7]},
      {title:'Саналы бөлісу',text:'Тексермей бөліспе. Deepfake және манипуляцияға сақ бол.',qIdx:[8,9,10,11]},
    ],
    questions:[
      {q:'Фейк жаңалық белгісі',o:['Тақырып пен мәтін сәйкес','Эмоцияға қысым, айқайлы тақырып','Дереккөз көрсетілген','Күні нақты'],a:1,e:'Эмоцияға қысым — фейк белгісі.'},
      {q:'Дереккөзді қалай тексереміз?',o:['Кездейсоқ чат','Ресми/беделді дереккөз','Тек комментарий','Тек мем'],a:1,e:'Ресми дереккөзге сүйен.'},
      ...
      {q:'Фейк көрсең',o:['Тез бөлісу','Алдымен тексеру','Эмоциямен тарату','Көргенді қайталау'],a:1,e:'Алдымен тексер, содан кейін ғана бөліс.'},
      {q:'Сатира жаңалық',o:['Әзіл ретінде жазылған','Әрқашан шын','Ресми құжат','Ғылыми зерттеу'],a:0,e:'Сатира — әзілдік жанр.'},
      {q:'Фактчек үшін дұрыс қадам',o:['Бірнеше дереккөзбен салыстыру','Тек бір сторис','Тек комментарий','Тек мем'],a:0,e:'Бірнеше дереккөз — негізгі ереже.'},
      {q:'Дәлелдің белгісі',o:['Лайк саны','Сілтеме, дерек, құжат','Эмоция','Қауесет'],a:1,e:'Дерек пен дәлел қажет.'},
  ...
  },
  {
    ...
    modules:[
      {title:'Жеке дерек ұғымы',text:'ИИН, паспорт, телефон, адрес — жеке дерек. Оларды тек қажет кезде ғана бер.',qIdx:[0,1,2,3]},
      {title:'Рұқсаттар мен келісім',text:'Қосымша рұқсаттарын шекте, келісім мәтінін қысқаша оқы.',qIdx:[4,5,6,7]},
      {title:'Қауіпке жауап',text:'Құрылғы жоғалса — бұғатта, парольді ауыстыр және ресми органдарға хабарла.',qIdx:[8,9,10,11]},
    ],
    questions:[
      ...
      {q:'Қоғамдық Wi‑Fi',o:['Банкке кіру','VPN қолдану немесе қолданбау','Құпиясөз жіберу','Файлдарды ашу'],a:1,e:'Қоғамдық Wi‑Fi‑да VPN қолдану қауіпсіз.'},
      ...
      {q:'Құрылғы жоғалса',o:['Ештеңе істемеу','Қашықтан бұғаттау/табу/өшіру','SIM-ді ашық қалдыру','Парольді жазу'],a:1,e:'Remote lock/erase — ең дұрыс қадам.'},
      {q:'Сақтық көшірме',o:['Қажет емес','Шифрлап сақтау','Әркімге тарату','Қоғамдық дискіге'],a:1,e:'Қауіпсіз резерв — деректі қорғайды.'},
      {q:'Құжат фотосын чатқа жіберу',o:['Қауіпсіз','Қауіпті, тек ресми арнамен','Әрқашан болады','Тек түнде'],a:1,e:'Құжатты тек ресми арнамен жібер.'},
      {q:'Әлеуметтік инженерия',o:['Техникалық ғана','Адамды сендіру арқылы дерек алу','Антивирус','Wi‑Fi'],a:1,e:'Бұл — психологиялық айла.'},
  ...
  },
  {
    ...
    modules:[
      {title:'Кибербуллинг түрлері',text:'Қорлау, қоқан‑лоқы, доксинг — кибербуллинг түрлері. Оларды елемеу емес, дұрыс әрекет маңызды.',qIdx:[0,1,2,3]},
      {title:'Қорғану және көмек',text:'Блоктау, дәлел жинау және платформаға шағымдану көмектеседі.',qIdx:[4,5,6,7]},
      {title:'Онлайн этика',text:'Авторлық құқықты сыйла, рұқсатсыз контент таратпа, өзгелердің шекарасын құрметте.',qIdx:[8,9,10,11]},
    ],
    questions:[
      {q:'Кибербуллинг деген не?',o:['Онлайн қорлау/қысым','Ойын','Жарнама','Құпия'],a:0,e:'Кибербуллинг — онлайн қысым.'},
      {q:'Кибербуллинг түрлері',o:['Доксинг, қорқыту, мазақ','Тек лайк','Тек жаңалық','Тек мем'],a:0,e:'Бұл қысымның түрлі формалары.'},
      {q:'Дұрыс әрекет',o:['Жауап беру','Блоктау және дәлел сақтау','Қорлау','Ештеңе істемеу'],a:1,e:'Блоктау және дәлел сақтау маңызды.'},
      {q:'Дәлелді қалай сақтаймыз?',o:['Скриншот сақтау','Жою','Қорқыту','Тарату'],a:0,e:'Скриншот — негізгі дәлел.'},
      {q:'Шағымдану қайда?',o:['Платформаға хабарлау','Тек достарға','Елемеу','Кек алу'],a:0,e:'Платформаға шағымдану қажет.'},
      ...
      {q:'Онлайн этика',o:['Әдептілік және құрмет','Қорлау','Көшіріп алу','Спам'],a:0,e:'Этика — құрмет пен әдеп.'},
      {q:'Авторлық құқық',o:['Қажет емес','Рұқсатсыз пайдалану заңсыз','Тек мектепте','Тек ойын'],a:1,e:'Авторлық құқықты сақтау керек.'},
      ...
      {q:'Қауіп төнсе',o:['Кек алу','Бұғаттау, дәлел, хабарлау','Профильді өшіру және үнсіз','Барлығын жіберу'],a:1,e:'Қауіп болса — бұғаттап, хабарла.'},
    ]
  },
  {
    id:'ai',
    ...
    modules:[
      {title:'AI негіздері',text:'AI қате жауап беруі мүмкін және дерекке байланысты қисайуы бар. Сондықтан тексеру қажет.',qIdx:[0,1,2,3]},
      {title:'Қауіпсіз пайдалану',text:'Жеке деректерді енгізбе, құпия ақпаратты бөліспе және AI‑ды көмекші ретінде пайдалан.',qIdx:[4,5,6,7]},
      {title:'Тексеру және жауапкершілік',text:'Нәтижені тексер, дереккөз көрсет және жауапкершілікпен қолдан.',qIdx:[8,9,10,11]},
    ],
    questions:[
      ...
      {q:'AI жауаптарын тексеру',o:['Қажет емес','Кемінде 2 дереккөз','Тек бір блог','Тек видео'],a:1,e:'Тексеру — міндет.'},
      ...
      {q:'Плагиатқа қатысты',o:['AI мәтінін сол күйі тапсыру','Дереккөз көрсету және өз сөзіңмен өңдеу','Ештеңе қажет емес','Тек көшіріп алу'],a:1,e:'Өз сөзіңмен өңдеу қажет.'},
      {q:'Deepfake туралы',o:['Бәрі шынайы','Жалған контент болуы мүмкін','Тек фильм','Тек ойын'],a:1,e:'Deepfake — жасанды контент.'},
      {q:'Модель сенімділігі',o:['Әрқашан бірдей','Жауап өзгеруі мүмкін','Жоқ','Тек офлайн'],a:1,e:'Модель жаңартылса жауап өзгереді.'},
      ...
      {q:'API кілті',o:['Жариялау','Жасырын сақтау','Чатта жіберу','Құжатқа жазу'],a:1,e:'Кілт құпия болуы керек.'},
